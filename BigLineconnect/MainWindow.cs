...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v2.6.1 - Uzaktan Kontrol (Instant Mouse Jump)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v2.6.1 (Instant Mouse Coalescing & DXGI 60FPS)",
