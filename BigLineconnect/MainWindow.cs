...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v4.00.0 - Uzaktan Kontrol (Native H.264 GPU Hardware & WebRTC Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v4.00.0 (Native H.264 GPU Hardware & WebRTC Engine)",
