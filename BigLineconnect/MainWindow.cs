...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.65.0 - Uzaktan Kontrol (Zero-Backlog Real-Time Drain Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.65.0 (Zero-Backlog Real-Time Drain Engine)",
