...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.61.3 - Uzaktan Kontrol (P2P LAN Direct Engine & Web Session Sync)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.61.3 (P2P LAN Direct Engine & Web Session Sync)",
