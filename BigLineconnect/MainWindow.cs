...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.68.0 - Uzaktan Kontrol (Rock-Solid Ultra-Fast Stable Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.68.0 (Rock-Solid Ultra-Fast Stable Engine)",
