...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.30.18 - Uzaktan Kontrol (Pristine Original Binary Icon Restored)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.30.18 (Pristine Original Binary Icon Restored)",
