...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.63.0 - Uzaktan Kontrol (0.1s Instant Screen Launch & Parallel Pipeline Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.63.0 (0.1s Instant Screen Launch & Parallel Pipeline Engine)",
