...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.30.20 - Uzaktan Kontrol (Cyan Frame True BC Logo Edition)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.30.20 (Cyan Frame True BC Logo Edition)",
