...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v4.07.0 - Uzaktan Kontrol (100% HD Crystal Clear Resolution Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v4.07.0 (100% HD Crystal Clear Resolution Engine)",
