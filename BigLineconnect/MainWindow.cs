...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.62.2 - Uzaktan Kontrol (0.5s Ultra-Fast Connection Speed Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.62.2 (0.5s Ultra-Fast Connection Speed Engine)",
