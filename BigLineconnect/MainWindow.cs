...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        public MainWindow()
        {
            ...
            InitializeComponent();
            this.Text = "B-Connect v3.80 ⚡ Turbo Kristal (0-Ghost Fare / Kesintisiz Akıcı)";
            LoadLogoAndIcon();
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.71.2 - Uzaktan Kontrol (Commercial PRO License & 10-Minute Free Session Limits Engine)";
            ...
            {
                Text = "v3.80 ⚡ Turbo Kristal (0-Ghost Fare / Kesintisiz Akıcı)",
        ...
        private void ConnectButton_Click(object? sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen 9 haneli geçerli bir ID, IP adresi (Örn: 192.168.1.101), Alan Adı veya Bilgisayar Adı (Örn: AHMET-PC) girin.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            if (isDirectHost)
            {
                // Direct IP / Domain Name (DNS) / Computer Name (NetBIOS/mDNS) Connection
                string host = targetId.Contains(":") ? targetId : $"{targetId}:18888";
                clientWsUrl = $"ws://{host}/";
                AppendLog($"[Doğrudan Bağlantı (IP / DNS / Bilgisayar Adı)] {host} adresine doğrudan (0.5 ms) bağlanılıyor...");
            }
            else
            {
