...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.30.19 - Uzaktan Kontrol (Final Cyan Border Edition)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.30.19 (Final Cyan Border Edition)",
