...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.3.0 - Uzaktan Kontrol (Zero-Backlog Deduplication Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.3.0 (Zero Socket Congestion & Ultra-Fast Deduplication)",
