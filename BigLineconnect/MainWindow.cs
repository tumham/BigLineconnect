...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.64.0 - Uzaktan Kontrol (Direct GPU Canvas & Zero-Queue Latency Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.64.0 (Direct GPU Canvas & Zero-Queue Latency Engine)",
