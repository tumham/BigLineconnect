...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.30.17 - Uzaktan Kontrol (Classic Original Logo Restored)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.30.17 (Classic Original Logo Restored)",
