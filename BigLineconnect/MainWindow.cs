...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v4.05.0 - Uzaktan Kontrol (Direct Win32 SendInput Native Hardware Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v4.05.0 (Direct Win32 SendInput Native Hardware Engine)",
