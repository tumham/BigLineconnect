...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.4.0 - Uzaktan Kontrol (Responsive Flow Toolbar)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.4.0 (FlowToolbar Layout & Zero Button Overlap)",
