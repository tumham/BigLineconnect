...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.67.0 - Uzaktan Kontrol (BigLine-RT 64x64 Differential Tile Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.67.0 (BigLine-RT 64x64 Differential Tile Engine)",
