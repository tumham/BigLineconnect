...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.66.0 - Uzaktan Kontrol (GDI Hybrid Instant Capture Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.66.0 (GDI Hybrid Instant Capture Engine)",
