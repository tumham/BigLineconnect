...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.30.10 - Uzaktan Kontrol (Silent Auto Firewall Pre-Approve Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.30.10 (Silent Auto Firewall Pre-Approve Engine)",
