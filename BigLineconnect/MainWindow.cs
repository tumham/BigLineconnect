...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v4.04.0 - Uzaktan Kontrol (Ultra-Fast 60 FPS Scaling Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v4.04.0 (Ultra-Fast 60 FPS Scaling Engine)",
