...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v3.7.0 - Uzaktan Kontrol (Winlogon Instant Input & Zero Slowness Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v3.7.0 (Winlogon Instant Input & Single Streamer Mutex)",
