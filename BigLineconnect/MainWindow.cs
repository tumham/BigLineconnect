...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v4.03.0 - Uzaktan Kontrol (Instant Action Frame Pushing Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v4.03.0 (Instant Action Frame Pushing Engine)",
