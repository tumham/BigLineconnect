...
namespace BigLineconnect
{
    public class MainWindow : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "BigLineconnect v4.06.0 - Uzaktan Kontrol (Instant Excel & Mikro Grid Engine)";
            ...
            {
                Text = "REMOTE DESKTOP CLIENT • v4.06.0 (Instant Excel & Mikro Grid Engine)",
