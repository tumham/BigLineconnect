try {
    $connStr = "Server=213.142.159.18;Database=MikroDesktop_MAHMUT;User Id=sa;Password=Bm1453;Encrypt=False;Connection Timeout=10;"
    Write-Host "Connecting to 213.142.159.18 Database MikroDesktop_MAHMUT..."
    $conn = New-Object System.Data.SqlClient.SqlConnection($connStr)
    $conn.Open()
    Write-Host "SUCCESS! CONNECTED TO MikroDesktop_MAHMUT ON 213.142.159.18!"
