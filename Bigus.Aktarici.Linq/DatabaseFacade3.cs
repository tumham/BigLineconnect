...
namespace Bigus.Aktarici.Linq
{
    public class DatabaseFacade3
    {
        ...
        public static bool SettingsOku()
        {
            ...
            if (File.Exists(Application.StartupPath + "\\Settings3.xml") == false)
            {
                DosyaOlustur();
            }


            ds.ReadXml(Application.StartupPath + "\\Settings3.xml");
        ...
        {
            XmlTextWriter textWriter = new XmlTextWriter(Application.StartupPath + "\\Settings3.xml", System.Text.Encoding.GetEncoding(1254));
